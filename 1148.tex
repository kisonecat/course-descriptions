...
\begin{Text}
College Algebra \& Trigonometry, 1st Edition, by Miller and Gerken, published by McGraw-Hill. ISBN: 9781259976612

Technology: All students are required to have a graphing calculator, TI-83 or TI-84. Note: Any calculators (including TI-89 and TI-92) that use a Computer Algebra System (CAS) are not permitted.
\end{Text}
