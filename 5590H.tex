...
\course{5590H}
%% Imported from the sheet Math 5590H shares with 5591H; the sections below are common to both.
...
\begin{Text}
Vary, for example: • \emph{Abstract \emph{Algebra}}, 3\textsuperscript{rd} edition, by Dummit \& Foote, published by Wiley, ISBN: 9780471433349 • Algebra, by M. Artin • \emph{Topics in Algebra}, by I. Herstein
\end{Text}
